...
class DeptTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = Dept.sampleData[indexPath.row].title

        cell.imageView?.image = UIImage(named: Dept.sampleData[indexPath.row].logo)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let viewController = segue.destination as? EventTableViewController {
            ...
            viewController.code = Dept.sampleData[selectedIndex.row].code
        }
    }
